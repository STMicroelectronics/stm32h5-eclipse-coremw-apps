...
<center>
# Release Notes for
# <mark>STM32 USB-C Power Delivery H5 Device Driver</mark>
...
<label for="collapse-section5" aria-hidden="true">V1.3.1 / 25-Sep-2025</label>
<div>
...
## Dependencies
 ...
 This software release is compatible with USB-C Power Delivery Core Stack Library v4.3.2
...
<label for="collapse-section4" aria-hidden="true">V1.3.0 / 17-April-2024</label>
<div>
...
**Fixed bugs list**
  ...
  Headline
  --------
  Astyle & codespell corrections
  Add protection of DMA init function if using the "no-pd" lib
  Add DMA secure configuration in case of secure application
  Remove the now always supported "USBPD_REV30_SUPPORT" compilation switch
  Modify timing for low power DRP
