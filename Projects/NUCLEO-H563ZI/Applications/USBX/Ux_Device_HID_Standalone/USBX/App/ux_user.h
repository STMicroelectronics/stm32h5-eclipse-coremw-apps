...
*/
/* #define _ux_utility_time_get() xTaskGetTickCount()  */
...
*/
/* #define _ux_utility_interrupt_disable() portSET_INTERRUPT_MASK_FROM_ISR()  */
...
*/
/* #define _ux_utility_interrupt_restore(flags) portCLEAR_INTERRUPT_MASK_FROM_ISR(flags)  */
...
/* #define UX_ASSERT_FAIL  for (;;) {vTaskDelay(UX_WAIT_FOREVER); }  */
